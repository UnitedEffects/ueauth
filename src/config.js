...
const config = {
	...
	DEFAULT_NOTIFICATION_PLUGIN_URL: process.env.DEFAULT_NOTIFICATION_PLUGIN_URL || envVars.DEFAULT_NOTIFICATION_PLUGIN_URL,
	DEFAULT_NOTIFICATION_API_IDENTIFIER: process.env.DEFAULT_NOTIFICATION_API_IDENTIFIER || envVars.DEFAULT_NOTIFICATION_API_IDENTIFIER,
};
