...
const config = {
	...
	MEMBER_PERMISSIONS: ['member:::accounts::update:own', 'member:::accounts::read:own', 'member:::accounts::delete:own', 'member:::invites::read:own', 'member:::userAccess::delete:own', 'member:::userAccess::read:own','member:::operations-reset-user-password::create', 'member:::operations-user::create:own', 'member:::operations-invite::create:own'],
	EVENT_EMITTER: {
		general: true,
		accessToken: true,
		authorization: true,
